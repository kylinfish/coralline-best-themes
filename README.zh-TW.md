...
![coralline 主題選擇器——即時瀏覽與套用主題](./assets/theme-picker-demo.gif)
...
![選擇器一邊瀏覽一邊即時預覽 statusline](./assets/theme-picker-demo.png)
...
bash ~/.claude/coralline-src/tools/theme-picker.sh   # 瀏覽全部 79 套主題,enter 套用
```

_這樣就有主題 + 選擇器了。把它接進 Claude Code 的 statusline(以及所有繼承自上游 coralline
的內容)請見下方收合區塊。_

<details>
<summary><b>📦 用 AI 安裝（有趣的方式）</b>——繼承自上游 coralline</summary>
...
<details>
<summary><b>🧩 區段一覽</b>——這條 statusline 各部分顯示什麼（繼承自上游）</summary>
...
<details>
<summary><b>🛠️ 手動安裝</b>——自己複製檔案 + 接進 settings.json</summary>
...
<details>
<summary><b>🎨 原本內建的主題與自製主題</b>——上游的 7 套主題（繼承自上游）</summary>

> 想找 72 套主題包？在最上方的
> [**✨ 這個 fork 新增了什麼**](#-這個-fork-新增了什麼72-套主題--互動式選擇器),直接跑
> `bash tools/theme-picker.sh`。

上游內建 7 套手調主題:`claude-coral`(預設)、`catppuccin-mocha`、`nord`、`gruvbox-dark`、
`tokyo-night`、`mono`、`dracula`。
...
<details>
<summary><b>🙏 致敬與致謝</b>——Powerlevel10k 與 powerline 系譜（繼承自上游）</summary>
